...
<head>
    <title>TestHub. <fmt:message key="create.question"/></title>
    <meta charset="UTF-8">
...
<div class="container">
    <div class="mx-auto" style="max-width: 500px;">
        <form action="controller" method="POST">
            ...
            <input type="hidden" name="testId" value="${requestScope.question.testId eq null ?
                                param.testId : requestScope.question.testId}">

            <h3 class="text-center mb-4"><fmt:message key="create.question"/></h3>
            ...
            <div class="mt-4 bg-secondary-subtle rounded" id="answersDiv">
                ...
                <c:choose>
                    <c:when test="${not empty requestScope.answersText}">
                        <c:forEach var="answerText" items="${requestScope.answersText}">
                            ...
                            <div class="d-flex p-2" id="formCheckDiv${count}">
                                ...
                                <div class="form-floating ms-1 col">
                                    <input class="form-control" type="text" name="answer${count}" id="answer${count}"
                                           placeholder="Answer" maxlength="150" value="${answerText}" required>
                    ...
                    <c:otherwise>
                        <c:forEach begin="1" end="4">
                            ...
                            <div class="d-flex p-2" id="formCheckDiv${count}">
                                <div class="form-check d-flex align-items-center">
                                    <input class="form-check-input" type="checkbox" name="correct${count}"
                                           value="true" id="correct${count}">
                                    <label for="correct${count}"></label>
                                </div>

                                <div class="form-floating ms-1 col">
                                    <input class="form-control" type="text" name="answer${count}" id="answer${count}"
                                           placeholder="Answer" maxlength="150" required>
                                    <label for="answer${count}"><fmt:message key="answer"/> ${count}</label>
                                </div>
                            </div>
                        </c:forEach>
