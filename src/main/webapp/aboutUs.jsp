...
<head>
    <title>TestHub. <fmt:message key="aboutUs"/></title>
    <meta charset="UTF-8">
...
<div class="container">
    ...
    <div class="text-center">
        ...
        <p class="m-auto" style="max-width: 800px;"><fmt:message key="aboutUs.text"/></p>
    </div>
