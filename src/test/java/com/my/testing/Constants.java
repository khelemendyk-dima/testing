...
public class Constants {
    ...
    public static final String NAME_VALUE = "Ivan";
    public static final String SURNAME_VALUE = "Petrov";
    ...
    public static final boolean IS_CORRECT_VALUE = false;
    public static final float RESULT_VALUE = 77.7f;
}
